...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tiatoolbox-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15236&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tiatoolbox-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tiatoolbox` can be installed with:

```
conda install tiatoolbox
```

It is possible to list all of the versions of `tiatoolbox` available on your platform with:
